...
L5R8L6L10L6R8R10L6L6L6R8L6L
    ...
    def calibrate(self):
        ...
        for coord in self.coords:
            (x,y) = coord
            if (x-1, y) in self.coords and (x+1, y) in self.coords and (x, y-1) in self.coords and (x, y+1) in self.coords:
...
if __name__ == '__main__':
    ascii = Scaffolding()
    ascii.run()
    print(f"part 1: {ascii.calibrate()}")
